"""
This file, base_v2.py, is a refactored version of base.py.

The complex `training_losses` method has been removed.
Its responsibility is now delegated to the main training script (e.g., train_cifar10.py),
which makes the overall logic clearer and less prone to versioning errors.

This class now purely manages the mathematical properties and sampling loops of the diffusion process.
"""
...
class GaussianDiffusionBeatGans:
    ...
    NOTE: In this V2 version, the complex `training_losses` method has been removed.
    The main training script is now responsible for all loss calculations.
    This class provides the core utilities for the diffusion process itself.
    """
    ...
    # ================================================================================= #
    # The training_losses method has been REMOVED.                                     #
    # All loss calculation logic now resides in the main training script for clarity.   #
    # ================================================================================= #
    ...
    # ... (all other helper methods like _predict_xstart_from_eps, p_sample, p_sample_loop, etc. remain unchanged) ...
    # ... a large number of methods are omitted here for brevity but should be included in the actual file ...

# ... (all utility functions like _extract_into_tensor, get_named_beta_schedule, etc. remain unchanged) ...
